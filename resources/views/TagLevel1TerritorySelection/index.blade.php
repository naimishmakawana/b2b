                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach ($Level1Territories as $Level1Territory)
                                        <tr id="row_{{$Level1Territory->Level1TerritoryId}}">
                                            ...
                                            <td>
                                                @if ($Level1Territory->IsNFCTagFoundINL1Ter == 0)
                                                    <a id="2TerritoryLink{{$Level1Territory->Level1TerritoryId}}" href="TagLevel2TerritorySelection?id={{$Level1Territory->CampaignLevel1TerritoryId}}" style="<?=empty($Level1Territory->TargetURL)?"display: block;":"display: none;";?>">Add / Remove</a>
                                                @endif
                                            </td>
                                             
                                            <td>
                                                @if ($Level1Territory->IsNFCTagFoundINL2Ter == 0)
                                                    <a href="{{URL::to('/CampaignWithTerTagsStep3')}}?id=<?=$Level1Territory->CampaignLevel1TerritoryId?>">Add / Remove Tags</a>
                                                @endif
                                            </td>
