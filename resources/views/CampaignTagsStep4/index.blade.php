            ...
            <div class="card">
                    ...
                    <div class="material-datatables">
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Tag Bundle ID</th>
                                            <th class="text-center">Tag URL</th>
                                    ...
                                    @foreach ($CampaignNFCTags as $CampaignNFCTag)
                                        <tr id="row_{{$CampaignNFCTag->NFCTagId}}">
                                          <td class="text-center">{{$CampaignNFCTag->TagBundleId}}</td>
                                            <td class="text-center">{{$CampaignNFCTag->ManufacturerName}}</td>
                                            <td class="text-center">{{$CampaignNFCTag->TagBundleId}}</td>
                                            <td class="text-center">{{$CampaignNFCTag->TagURL}}</td>
                                            <td class="text-center">{{$CampaignNFCTag->RedirectURL}}</td>
                                             <td class="text-center">
                                                <a class="btn btn-simple btn-danger btn-icon" onclick="OnRemoveTagFromCampaign('{{$CampaignNFCTag->NFCTagId}}',{{$CampaignId}})" href="#"><i class="material-icons dp48">remove_circle</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                          ...
                          <!--   <div class="col-md-12" style="text-align: center;"> 
                                 <a  href="{{ url('NFCTagBundle/create') }}?id=<?=$CampaignId?>" class="btn btn-primary btn">Create New Tag Bundle</a>
                            </div> -->
                                ...
                                <table id="datatables2" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach ($AvailableCampaignNFCTags as $AvailableCampaignNFCTag)
                                        ...
                                        <tr id="row_{{$AvailableCampaignNFCTag->NFCTagId}}"> 
                                            ...
                                            <td class="text-center">{{$AvailableCampaignNFCTag->TagBundleId}}</td>
                                            <td class="text-center">{{$AvailableCampaignNFCTag->TagURL}}</td>
                                            <td class="text-center">{{$AvailableCampaignNFCTag->RedirectURL}}</td>
                                              <td class="text-center">
                                                <a class="btn btn-simple btn-success btn-icon remove" onclick="OnAddTagInCampaign('{{$AvailableCampaignNFCTag->NFCTagId}}',{{$CampaignId}})" href="#"><i class="material-icons dp48">add_circle</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
