        ...
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row" style="text-align: center;"> 
                         <div class="col-md-12">
                                <b>Level 2 Territory Name : {{$Level2TerritoryName}}</b>
                         </div>
                    </div>
                    ...
                    <div class="material-datatables">
                                        ...
                                        <tr id="row_{{$CampaignNFCTag->NFCTagId}}">
                                            ...
                                            <td class="text-center"><a href="#">Add / Remove</a></td>
                                             <td class="text-center">
                                                <a class="btn btn-simple btn-danger btn-icon" onclick="OnRemoveTagBundleFromL2Territory('{{$CampaignNFCTag->TagBundleId}}',{{$CampaignLevel2TerritoryId}})" href="#"><i class="material-icons dp48">remove_circle</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                          ...
                          <!--   <div class="col-md-12" style="text-align: center;"> 
                                 <a  href="{{ url('NFCTagBundle/create') }}?id=<?=$CampaignLevel2TerritoryId?>" class="btn btn-primary btn">Create New Tag Bundle</a>
                            </div> -->
                                    ...
                                    @foreach ($AvailableCampaignNFCTags as $AvailableCampaignNFCTag)
                                        <tr id="row_{{$AvailableCampaignNFCTag->NFCTagId}}"> 
                                            ...
                                            <td class="text-center"><a href="#" data-toggle="modal" data-target=".example-modal-lg" onclick="ViewTagBundleInTags('{{$AvailableCampaignNFCTag->TagBundleId}}')">View</a></td>
                                              <td class="text-center">
                                                <a class="btn btn-simple btn-success btn-icon remove" onclick="OnAddTagBundleInL2Territory('{{$AvailableCampaignNFCTag->TagBundleId}}',{{$CampaignLevel1TerritoryId}},{{$CampaignLevel2TerritoryId}},{{$CampaignId}})" href="#"><i class="material-icons dp48">add_circle</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
