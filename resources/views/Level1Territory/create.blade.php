    ...
    @endif 
               ...
               <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                 {!! Form::open(array('route' => 'Level1Territory.store','method'=>'POST', 'class'=>'form-horizontal', 'id'=>'solution_feature')) !!}
                                    <div class="card-header card-header-text">
                                        <h4 class="card-title">Level 1 Territory</h4>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input class="form-control" type="text" name="Level1TerritoryName" required="true" />
                                                </div>
                                            </div>
