                                        ...
                                        <tr id="row_{{$CampaignNFCTag->NFCTagId}}">
                                            ...
                                            <td class="text-center"><a href="#">Add / Remove</a></td>
                                             <td class="text-center">
                                                <a class="btn btn-simple btn-danger btn-icon" onclick="OnRemoveTagBundleFromCampaign('{{$CampaignNFCTag->TagBundleId}}',{{$CampaignId}})" href="#"><i class="material-icons dp48">remove_circle</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <table id="datatables2" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach ($AvailableCampaignNFCTags as $AvailableCampaignNFCTag)
                                        <tr id="row_{{$AvailableCampaignNFCTag->NFCTagId}}"> 
                                            ...
                                            <td class="text-center"><a href="{{URL::to('/CampaignTagsStep4')}}?id={{$CampaignId}}">Add / Remove</a></td>
                                            <td class="text-center"><a href="#" data-toggle="modal" data-target=".example-modal-lg" onclick="ViewTagBundleInTags('{{$AvailableCampaignNFCTag->TagBundleId}}')">View</a></td>
                                              <td class="text-center">
                                                <a class="btn btn-simple btn-success btn-icon remove" onclick="OnAddTagBundleInCampaign('{{$AvailableCampaignNFCTag->TagBundleId}}',{{$CampaignId}})" href="#"><i class="material-icons dp48">add_circle</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
