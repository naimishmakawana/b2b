...
class TagLevel2TerritorySelectionController extends Controller
{
    public function index()
    {
        ...
        $Level2Territories = Level2Territory::select("B2BCustomer.NameOfOrganization","Level2Territory.*","CampaignLevel2Territory.CampaignLevel2TerritoryId","CampaignLevel2Territory.TargetURL","B2BCustomerCampaign.CampaignName", "CampaignLevel1Territory.CampaignId")
        ...
        return view('TagLevel2TerritorySelection.index',compact('Level2Territories'),compact('AvailableLevel2Territories'))
