            ...
            <div class="card">
                    ...
                    <div class="material-datatables">
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach ($Level2Territories as $Level2Territory)
                                        <tr id="row_{{$Level2Territory->Level2TerritoryId}}">
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-simple btn-warning btn-icon edit" href="{{ route('Level2Territory.edit',$Level2Territory->Level2TerritoryId) }}?camterid=<?=$_GET['id']?>"><i class="material-icons">dvr</i></a>
                                            </td>
                            ...
                            <div class="col-md-12" style="text-align: center;"> 
                                 <a  href="{{ url('Level2Territory/create') }}?camterid=<?=$CampaignLevel1TerritoryId;?>" class="btn btn-primary btn">Create New Level 2 Territory</a>
                            </div>
                                ...
                                <table id="datatables2" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach ($AvailableLevel2Territories as $AvailableLevel2Territory)
                                        <tr id="row_{{$AvailableLevel2Territory->Level2TerritoryId}}"> 
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-simple btn-warning btn-icon edit" href="{{ route('Level2Territory.edit',$AvailableLevel2Territory->Level2TerritoryId) }}?camterid=<?=$_GET['id']?>"><i class="material-icons">dvr</i></a>
                                            </td>
     ...
     <div class="modal fade example-modal-lg2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" id="CamTerL1Modal">
               ...
               @if (isset($_GET['flag']) && ($_GET['flag'] == 'cmptagbundle' || $_GET['flag'] == 'cmpqrcode'))
